        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h1 className="mt-8 text-5xl lg:text-6xl font-black leading-tight text-gray-900">
              ...
              <span className="text-blue-700"> Through Responsible Growth</span>

            </h1>

            <p className="mt-8 text-lg leading-9 text-gray-600">

              At Hi Spring, we strive to operate responsibly by
              maintaining efficient manufacturing practices,
              delivering safe drinking water, and supporting the
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg leading-9 text-gray-600 max-w-4xl mx-auto">
              ...
              We continuously work to improve our production
              processes while maintaining high standards of
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="rounded-[35px] bg-white p-10 shadow-lg">
              ...
              <p className="mt-6 text-gray-600 leading-8">
                ...
                Modern production practices help us maintain
                efficient operations while consistently delivering
            ...
            <div className="rounded-[35px] bg-white p-10 shadow-lg">
              ...
              <p className="mt-6 text-gray-600 leading-8">
                ...
                Our purification and quality monitoring processes
                help ensure safe, reliable drinking water for our
                customers.
            ...
            <div className="rounded-[35px] bg-white p-10 shadow-lg">
              ...
              <p className="mt-6 text-gray-600 leading-8">
                ...
                We are proud to contribute to communities by
                providing dependable access to quality drinking
                water.
            ...
            <div className="rounded-[35px] bg-white p-10 shadow-lg">
              ...
              <p className="mt-6 text-gray-600 leading-8">
                ...
                We remain committed to improving our facilities,
                technologies and customer service as we continue to
                grow.
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg leading-9 text-gray-600">
              ...
              Access to clean drinking water plays an important
              role in everyday life. Hi Spring is proud to serve
              homes, businesses and communities throughout
              Ethiopia with dependable bottled drinking water.
